...
<title>Order Confirmed — Amsaz Cosmetics</title>
<style>
...
<div class="wrap">
  ...
  <div class="body">
    ...
    <p class="subtext">
      Thank you for shopping with Amsaz Cosmetics! We've received your order and it's being prepared.
  ...
  <div class="footer">
    <p>Questions? Email us at <a href="mailto:support@Amsaz Cosmetics.com">support@Amsaz Cosmetics.com</a></p>
    <p style="margin-top:8px;">© {{ date('Y') }} Amsaz Cosmetics. All rights reserved.</p>
  </div>

...
@section('title', 'About Us — Amsaz Cosmetics')
...
@section('content')
    ...
    <section class="page-hero">
        <div class="container">
            <h1 class="page-hero-title">About Amsaz Cosmetics</h1>
    ...
    <section class="about-story-section">
        <div class="container about-content">
            ...
            <div class="about-text">
                <p>Amsaz Cosmetics was born from a simple belief — that everyone deserves access to the world's finest beauty products. Founded in Lahore, Pakistan, we have curated a collection that spans premium international brands and beloved local favourites.</p>

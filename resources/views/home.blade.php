...
@section('title', $setting->seo_title ?? 'Amsaz Cosmetics — Premium Luxury Cosmetics & Skincare Pakistan')
...
@section('content')
    ...
    <section class="hero" aria-label="Hero banner" id="hero-section">
        ...
        @else
        {{-- Static fallback --}}
        <img src="https://images.unsplash.com/photo-1522335789203-aabd1fc54bc9?w=1440&h=720&fit=crop" alt="Amsaz Cosmetics" loading="eager" style="position:absolute;inset:0;width:100%;height:100%;object-fit:cover;object-position:center top;">
        <div class="hero-overlay" aria-hidden="true"></div>
        <div class="hero-content">

...
<section class="newsletter-section" aria-labelledby="newsletter-heading">
    <h2 class="newsletter-title" id="newsletter-heading">Join the Amsaz Cosmetics Family</h2>
...
<footer class="site-footer" role="contentinfo">
    <div class="footer-main">
        <div class="footer-brand">
            <p class="footer-brand-logo">Amsaz <span>Cosmetics</span></p>
    ...
    <div class="footer-bottom">
        <p class="footer-copy">© {{ date('Y') }} Amsaz Cosmetics. All rights reserved.</p>

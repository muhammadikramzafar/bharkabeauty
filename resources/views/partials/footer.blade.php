...
<section class="newsletter-section" aria-labelledby="newsletter-heading">
    <h2 class="newsletter-title" id="newsletter-heading">Join the AmsazBeauty Family</h2>
...
<footer class="site-footer" role="contentinfo">
    <div class="footer-main">
        <div class="footer-brand">
            <p class="footer-brand-logo">Amsaz<span>Beauty</span></p>
    ...
    <div class="footer-bottom">
        <p class="footer-copy">© {{ date('Y') }} AmsazBeauty. All rights reserved.</p>

...
<header class="site-header" role="banner">
    <div class="header-top">
        ...
        <div class="header-logo">
            <a href="{{ route('home') }}" aria-label="Amsaz Cosmetics Home">Amsaz <span>Cosmetics</span></a>
        </div>
...
<div class="mobile-menu" id="mobile-menu" role="dialog" aria-modal="true" aria-label="Main menu">
    <div class="mobile-menu-header">
        <a href="{{ route('home') }}" style="font-family:'Playfair Display',serif;font-size:1.5rem;font-weight:700;color:var(--color-primary);">Amsaz <span style="color:var(--color-accent)">Cosmetics</span></a>

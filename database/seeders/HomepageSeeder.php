...
class HomepageSeeder extends Seeder
{
    public function run(): void
    {
        ...
        HomeSetting::instance()->update([
            ...
            'seo_title'           => 'Amsaz Cosmetics — Premium Luxury Cosmetics & Skincare Pakistan',
        ...
        if (!HomepageTestimonial::count()) {
            $testimonials = [
                ['reviewer_name' => 'Ayesha Khan', 'reviewer_location' => 'Lahore', 'review_text' => 'The quality is absolutely amazing. I\'ve been buying from Amsaz Cosmetics for 2 years and they never disappoint. Fast delivery and 100% authentic products!', 'rating' => 5, 'product_brand' => 'Huda Beauty', 'product_name' => 'Rose Gold Palette'],
